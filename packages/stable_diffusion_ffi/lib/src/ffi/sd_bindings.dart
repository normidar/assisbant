...
typedef _SdImagePtrDart = Pointer<SdImageT> Function(
    Pointer<Void>, Pointer<Uint8>);

class SdBindings {
  SdBindings(DynamicLibrary lib)
      : sdCtxParamsInit = lib.lookupFunction<_VoidPtrUint8C, _VoidPtrUint8Dart>(
            'sd_ctx_params_init'),
        newSdCtx = lib.lookupFunction<Pointer<Void> Function(Pointer<Uint8>),
            _VoidPtrFromPtrUint8Dart>('new_sd_ctx'),
        freeSdCtx =
            lib.lookupFunction<Void Function(Pointer<Void>), _VoidVoidPtrDart>(
                'free_sd_ctx'),
        sdImgGenParamsInit =
            lib.lookupFunction<_VoidPtrUint8C, _VoidPtrUint8Dart>(
                'sd_img_gen_params_init'),
        generateImage = lib.lookupFunction<
            Pointer<SdImageT> Function(Pointer<Void>, Pointer<Uint8>),
            _SdImagePtrDart>('generate_image');
