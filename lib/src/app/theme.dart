...
class AppColors extends ThemeExtension<AppColors> {
  ...
  AppColors copyWith({
    ...
    Color? border, Color? border2, Color? accent, Color? accentSoft,
    Color? stPending, Color? stPendingBg, Color? stRunning, Color? stRunningBg,
    Color? stDone, Color? stDoneBg, Color? stFailed, Color? stFailedBg,
    Color? stSkipped, Color? stSkippedBg,
  }) =>
      AppColors(
        bg: bg ?? this.bg,
...
ThemeData buildAppTheme() {
  ...
  return base.copyWith(
    ...
    cardColor: c.surface, dialogTheme: DialogThemeData(backgroundColor: c.surface),
  );
}
